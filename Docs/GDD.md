...
7. **Closing screen:** shown when the boss falls, in two beats. First the valley handed back, "The valley is yours again", with feathers thrown in from both sides and a short triumphant theme played once; then the birds the player rescued across the campaign, as the ending track begins.
